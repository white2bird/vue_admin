<template>
	<div style="width: 100%;">
		<div>
			<el-input v-model="goodName" placeholder="搜索商品" style="width: 240px;float: left;" clearable></el-input>
			<el-button type="primary" style="float: left;" @click="search">搜索商品</el-button>
			<el-button type="info" style="float: left;" @click="createUser">新增商品</el-button>
		</div>
		<el-table :data="tableData" style="display: flex;" :header-cell-style="{ background: '#f3f6fd', color: '#555' ,height:'60px'}">
		  ...
		  <el-table-column prop="goodCount" label="库存数量" width="160"/>
		  ...
		  <el-table-column prop="detail" label="介绍" width="160"/>
...
<script lang="ts" setup>
	...
	const getUser = () => {
		$http.post($pre_url + '/good/getList', {
